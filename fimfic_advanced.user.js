...
document.addEventListener("DOMContentLoaded", () => {
    ...
    try {
        ...
        console.log('FimficAdv: Setup complete successfully');
    } catch (e) {
...
function patchEvents() {
    window.override(EventTarget.prototype, 'addEventListener', function(ev, f, c) {
    ...
    window.override(EventTarget.prototype, 'removeEventListener', function(ev, f) {
    ...
    window.override(window.Function.prototype, 'bind', function(context) {
...
function earlyStart() {
	(function css() {
			if (document.body) return addCss();
			requestAnimationFrame(css);
	})();
	if (bannerController.getEnabled()) (function banner() {
			if (document.body && (userToolbar = document.body.querySelector('.user_toolbar'))) return bannerController.build();
